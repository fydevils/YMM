...
@interface VFSDKWalletAddressPicker : UIView <UIPickerViewDelegate, UIPickerViewDataSource>
{
    id <VFSDKWalletAddressPickerDelegate> _delegate;
    NSArray *_pickerArr;
...
@property(nonatomic) __weak id <VFSDKWalletAddressPickerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
