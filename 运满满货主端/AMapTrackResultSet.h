...
@class AMapTrackDatabase, AMapTrackStatement, NSDictionary, NSMutableDictionary, NSString;

@interface AMapTrackResultSet : NSObject
{
    NSMutableDictionary *_columnNameToIndexMap;
    AMapTrackDatabase *_parentDB;
    NSString *_query;
    AMapTrackStatement *_statement;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) AMapTrackStatement *statement; // @synthesize statement=_statement;
@property(retain) NSString *query; // @synthesize query=_query;
@property(retain, nonatomic) AMapTrackDatabase *parentDB; // @synthesize parentDB=_parentDB;
- (void).cxx_destruct;
