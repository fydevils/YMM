...
@class AMapLocationManager, AMapLocationReGeocode, AMapLocationRegion, CLHeading, CLLocation, NSError;
...
- (void)amapLocationManager:(AMapLocationManager *)arg1 didUpdateHeading:(CLHeading *)arg2;
- (_Bool)amapLocationManagerShouldDisplayHeadingCalibration:(AMapLocationManager *)arg1;
