...
@class NSMutableArray, NSString, TangramBus, UIScrollView, UIView;

@interface TangramScrollWaterFlowLayout : TangramWaterFlowLayout <UIScrollViewDelegate, TangramScrollLayoutProtocol>
{
