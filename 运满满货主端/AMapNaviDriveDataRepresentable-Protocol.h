...
@class AMapNaviCameraInfo, AMapNaviCruiseInfo, AMapNaviDriveManager, AMapNaviInfo, AMapNaviLocation, AMapNaviParallelRoadStatus, AMapNaviRoute, NSArray, NSString, UIImage;

@protocol AMapNaviDriveDataRepresentable <NSObject>

@optional
- (void)driveManager:(AMapNaviDriveManager *)arg1 updateBackupRoute:(NSArray *)arg2;
- (void)driveManager:(AMapNaviDriveManager *)arg1 updateTurnIconImage:(UIImage *)arg2 turnIconType:(long long)arg3;
- (void)driveManager:(AMapNaviDriveManager *)arg1 updateIntervalCameraWithPositionState:(long long)arg2 startInfo:(AMapNaviCameraInfo *)arg3 endInfo:(AMapNaviCameraInfo *)arg4;
- (void)driveManager:(AMapNaviDriveManager *)arg1 updateParallelRoadStatus:(AMapNaviParallelRoadStatus *)arg2;
