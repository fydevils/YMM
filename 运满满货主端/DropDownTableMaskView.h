...
@interface DropDownTableMaskView : YMMPopupMaskView <UITableViewDelegate, UITableViewDataSource>
{
    long long _selectIndex;
    id <DropDownTableMaskViewDelegate> _delegate;
...
@property(nonatomic) __weak id <DropDownTableMaskViewDelegate> delegate; // @synthesize delegate=_delegate;
