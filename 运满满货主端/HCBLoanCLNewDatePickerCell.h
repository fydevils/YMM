...
@class CAShapeLayer, NSString, UIDatePicker, UILabel, UITextField, UIView;

@interface HCBLoanCLNewDatePickerCell : UITableViewCell <UITextFieldDelegate>
{
...
- (id)sharpPath;
- (void)updateCellWithTitle:(id)arg1 content:(id)arg2 showLine:(_Bool)arg3;
- (void)layoutSubviews;
- (void)awakeFromNib;
