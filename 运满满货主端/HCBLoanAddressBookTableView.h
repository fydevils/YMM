...
@class HCBLoanAddressBookReader, NSArray, NSDictionary, NSString;

@interface HCBLoanAddressBookTableView : UITableView <UITableViewDataSource, UITableViewDelegate, HCBLoanAddressBookReaderDelegate>
{
