...
@interface YMMCargoDetailInfoCell : YMMBaseTableViewCell
{
    UILabel *_carTipLb;
    UILabel *_carInfoLb;
    UILabel *_cargoTipLb;
...
@property(retain, nonatomic) UILabel *carInfoLb; // @synthesize carInfoLb=_carInfoLb;
@property(retain, nonatomic) UILabel *carTipLb; // @synthesize carTipLb=_carTipLb;
- (void).cxx_destruct;
