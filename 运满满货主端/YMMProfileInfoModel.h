...
@interface YMMProfileInfoModel : YMMBaseModel
{
    NSString *_userId;
    NSString *_userName;
    long long _userType;
    ...
    long long _simpleAuthUser;
}

@property(nonatomic) long long simpleAuthUser; // @synthesize simpleAuthUser=_simpleAuthUser;
