...
+ (id)socketFromConnectedSocketFD:(int)arg1 delegate:(id)arg2 delegateQueue:(struct dispatch_queue_s *)arg3 socketQueue:(struct dispatch_queue_s *)arg4 error:(id *)arg5;
+ (id)socketFromConnectedSocketFD:(int)arg1 delegate:(id)arg2 delegateQueue:(struct dispatch_queue_s *)arg3 error:(id *)arg4;
+ (id)socketFromConnectedSocketFD:(int)arg1 socketQueue:(struct dispatch_queue_s *)arg2 error:(id *)arg3;
- (void).cxx_destruct;
- (struct SSLContext *)sslContext;
