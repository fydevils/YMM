...
#import "AMapNaviBottomInfoViewDelegate.h"
#import "AMapNaviMapContentViewDelegate.h"
#import "AMapNaviTopInfoViewDelegate.h"
#import "AMapNaviWalkDataRepresentable.h"
#import "CLLocationManagerDelegate.h"
#import "MAMapViewDelegate.h"

@class AMapNaviBottomInfoView, AMapNaviCarAnnotation, AMapNaviCarAnnotationView, AMapNaviGuidePolyline, AMapNaviInfo, AMapNaviLocation, AMapNaviMapContentView, AMapNaviPoint, AMapNaviRoute, AMapNaviTimerTarget, AMapNaviTopInfoView, CLHeading, CLLocationManager, MAMapView, NSMutableDictionary, NSString, NSTimer, UIButton, UIImage;

@interface AMapNaviWalkView : UIView <MAMapViewDelegate, AMapNaviMapContentViewDelegate, AMapNaviTopInfoViewDelegate, AMapNaviBottomInfoViewDelegate, CLLocationManagerDelegate, AMapNaviWalkDataRepresentable>
{
    ...
    id <AMapNaviWalkViewDelegate> _delegate;
    ...
    long long _state;
    id <AMapNaviWalkViewState> _viewState;
...
@property(retain, nonatomic) id <AMapNaviWalkViewState> viewState; // @synthesize viewState=_viewState;
...
@property(nonatomic) __weak id <AMapNaviWalkViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)walkManager:(id)arg1 updateNaviRouteID:(long long)arg2;
