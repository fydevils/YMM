...
@class AMapNetworkManager, CLLocationManager, MAAngleIndicator, MAAnnotationContainerView, MACircle, MACompassView, MAENInlandMapTileOverlay, MAGLESResourceProvider, MAIndoorInfo, MAIndoorView, MAInternalMapStatus, MAMapCustomStyleOptions, MAMapRender, MAMapStyleSetter, MAOverlayContainerView, MAScaleViewLite, MATapPanToZoomGestureRecognizer, MAUserLocation, MAUserLocationRepresentation, MAViewRecycler, MAWorldMapTileOverlay, MapStatus, NSData, NSDictionary, NSMutableArray, NSNumber, NSOperation, NSString, UIImageView, UILabel, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@interface MAMapView : UIView <UIGestureRecognizerDelegate, CLLocationManagerDelegate, MAMapEngineMapViewDelegate, MAMapRenderDelegate, MAOverlayContainerViewDelegate, MAAnnotationContainerViewDelegate, MACompassViewDelegate, MAIndoorViewDelegate>
{
    ...
    _Bool _isFromCustomStyleID;
    NSData *_origStyleTotalData;
    NSData *_origCustomStyleTextureData;
    _Bool _isResetCustomStyleTextureData;
    int _authResult;
    ...
    MAMapStyleSetter *_mapStyleSetter;
