...
@class NSArray, NSMutableArray, NSString, TangramBus, UIScrollView, UIView;

@interface TangramScrollFlowLayout : TangramFlowLayout <UIScrollViewDelegate, TangramScrollLayoutProtocol>
{
    ...
    NSMutableArray *_pagingCaptureImageViews;
    NSString *_subLayoutIndex;
    long long _lastCapturePageIndex;
}

@property(nonatomic) long long lastCapturePageIndex; // @synthesize lastCapturePageIndex=_lastCapturePageIndex;
...
@property(retain, nonatomic) NSMutableArray *pagingCaptureImageViews; // @synthesize pagingCaptureImageViews=_pagingCaptureImageViews;
