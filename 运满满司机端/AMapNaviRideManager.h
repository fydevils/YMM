...
#import "AMapNaviRideCoreDelegate.h"

@class AMapNaviInfo, AMapNaviLocation, AMapNaviPoint, AMapNaviRideCore, AMapNaviRoute, AMapNaviTimerTarget, NSArray, NSDictionary, NSHashTable, NSString, NSTimer;
...
@interface AMapNaviRideManager : AMapNaviBaseManager <AMapNaviRideCoreDelegate>
{
    ...
    AMapNaviPoint *_endPointThatCalculateRouteWithoutStartPoint;
    id <AMapNaviRideManagerInternalDelegate> _internalDelegate;
}

@property(nonatomic) __weak id <AMapNaviRideManagerInternalDelegate> internalDelegate; // @synthesize internalDelegate=_internalDelegate;
@property(retain, nonatomic) AMapNaviPoint *endPointThatCalculateRouteWithoutStartPoint; // @synthesize endPointThatCalculateRouteWithoutStartPoint=_endPointThatCalculateRouteWithoutStartPoint;
