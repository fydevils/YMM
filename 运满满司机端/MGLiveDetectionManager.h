...
@interface MGLiveDetectionManager : NSObject <MGLivenessProtocolDelegate>
{
    ...
    unsigned long long _currentLiveStep;
...
@property(readonly, nonatomic) unsigned long long currentLiveStep; // @synthesize currentLiveStep=_currentLiveStep;
...
- (void)starDetectionWithStep:(unsigned long long)arg1;
- (void)stopDetection;
- (void)recoveryData:(unsigned long long)arg1;
