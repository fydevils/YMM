...
@interface TapDetectingView : UIView
{
    ...
    _Bool _enableChangeCenterWithDoubleTouchPoint;
...
@property(nonatomic) _Bool enableChangeCenterWithDoubleTouchPoint; // @synthesize enableChangeCenterWithDoubleTouchPoint=_enableChangeCenterWithDoubleTouchPoint;
