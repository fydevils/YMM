...
@interface VFSDKAddressPicker : UIView <UIPickerViewDataSource, UIPickerViewDelegate>
{
    ...
    id <VFSDKAddressPickerDelegate> _delegate;
    UIPickerView *_pickerView;
}

@property(retain, nonatomic) UIPickerView *pickerView; // @synthesize pickerView=_pickerView;
@property(nonatomic) __weak id <VFSDKAddressPickerDelegate> delegate; // @synthesize delegate=_delegate;
