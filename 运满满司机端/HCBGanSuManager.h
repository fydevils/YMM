...
@interface HCBGanSuManager : NSObject
{
...
- (void).cxx_destruct;
- (id)nowDateFromatAnDate:(id)arg1;
- (void)etc_loadConfirm:(id)arg1 withBlock:(CDUnknownBlockType)arg2;
- (void)gs_loadApply80WithCardNo:(id)arg1 withMoney:(id)arg2 withOrderId:(id)arg3 withCardTrace:(id)arg4 withCardHistory:(id)arg5 withRandom:(id)arg6 withBalance:(id)arg7 withMac:(id)arg8 applyBlock:(CDUnknownBlockType)arg9;
- (void)gs_loadApply81WithCardNo:(id)arg1 withMoney:(id)arg2 withOrderId:(id)arg3 withCardTrace:(id)arg4 withCardHistory:(id)arg5 withRandom:(id)arg6 withBalance:(id)arg7 withMac:(id)arg8 applyBlock:(CDUnknownBlockType)arg9;
