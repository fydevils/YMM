...
+ (id)reformerWithDistanceSearchRequest:(id)arg1;
+ (id)reformerWithRoadTrafficCircleSearchRequest:(id)arg1;
+ (id)reformerWithRoadTrafficSearchRequest:(id)arg1;
+ (id)reformerWithTruckRouteSearchRequest:(id)arg1;
