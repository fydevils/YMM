...
@interface HCBLoanTabView : UIView
{
    NSArray *_titles;
    id <HCBLoanTabViewDelegate> _delegate;
...
@property(nonatomic) __weak id <HCBLoanTabViewDelegate> delegate; // @synthesize delegate=_delegate;
