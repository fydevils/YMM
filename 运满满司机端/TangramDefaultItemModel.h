...
@interface TangramDefaultItemModel : TMLazyItemModel <TangramItemModelProtocol>
{
    ...
    NSString *_specificReuseIdentifier;
...
@property(retain, nonatomic) NSString *specificReuseIdentifier; // @synthesize specificReuseIdentifier=_specificReuseIdentifier;
