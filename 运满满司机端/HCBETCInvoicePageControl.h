...
@interface HCBETCInvoicePageControl : UIControl
{
    ...
    id <HCBETCInvoicePageControlDelegate> _delegate;
    NSMutableArray *_dots;
    struct CGSize _dotSize;
}

@property(retain, nonatomic) NSMutableArray *dots; // @synthesize dots=_dots;
@property(nonatomic) id <HCBETCInvoicePageControlDelegate> delegate; // @synthesize delegate=_delegate;
