...
- (void).cxx_destruct;
- (id)pincodeWithCardVersion:(id)arg1;
- (void)getUnlockRandomWithBlock:(CDUnknownBlockType)arg1;
- (void)getUnlockApduCodeWithPincode:(id)arg1 withCardNo:(id)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)etc_loadConfirm:(id)arg1 withBlock:(CDUnknownBlockType)arg2;
- (void)vfj_loadApplyWithCardNo:(id)arg1 withMoney:(id)arg2 withOrderId:(id)arg3 withTacStr:(id)arg4 withCardHistory:(id)arg5 mac:(id)arg6 applyBlock:(CDUnknownBlockType)arg7;
