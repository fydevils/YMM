...
+ (void)hcb_swizzle:(SEL)arg1 to:(SEL)arg2;
+ (id)showToastAddedTo:(id)arg1 successWithText:(id)arg2;
+ (id)showToastAddedTo:(id)arg1 image:(id)arg2 labelText:(id)arg3 hideAfterDelay:(double)arg4 isTapToHideEnable:(_Bool)arg5;
+ (id)showToastAddedTo:(id)arg1 image:(id)arg2 labelText:(id)arg3 withGroupId:(long long)arg4;
+ (id)showToastAddedTo:(id)arg1 image:(id)arg2 labelText:(id)arg3;
+ (id)showToastAddedTo:(id)arg1 imageName:(id)arg2 labelText:(id)arg3 withGroupId:(long long)arg4;
+ (id)showToastAddedTo:(id)arg1 imageName:(id)arg2 labelText:(id)arg3;
+ (id)showToastAddedTo:(id)arg1 imageName:(id)arg2 labelText:(id)arg3 hideAfterDelay:(double)arg4 isTapToHideEnable:(_Bool)arg5;
+ (id)showToastAddedTo:(id)arg1 imageName:(id)arg2 labelText:(id)arg3 hideAfterDelay:(double)arg4 isTapToHideEnable:(_Bool)arg5 withGroupId:(long long)arg6;
+ (id)showToastAddedTo:(id)arg1 image:(id)arg2 labelText:(id)arg3 hideAfterDelay:(double)arg4 isTapToHideEnable:(_Bool)arg5 withGroupId:(long long)arg6;
+ (double)showTimeByContent:(id)arg1;
+ (id)showHUDAddedTo:(id)arg1 animated:(_Bool)arg2 text:(id)arg3 withCancelBlock:(CDUnknownBlockType)arg4;
+ (id)showHUDAddedTo:(id)arg1 animated:(_Bool)arg2 withCancelBlock:(CDUnknownBlockType)arg3;
+ (id)showHUDAddedTo:(id)arg1 animated:(_Bool)arg2 text:(id)arg3;
+ (_Bool)hcb_isCustomLoadingAnimationEnable;
+ (void)hcb_setCustomLoadingAnimationEnabled:(_Bool)arg1;
...
- (void)hcb_hideUsingAnimation:(_Bool)arg1;
- (void)hcb_showUsingAnimation:(_Bool)arg1;
- (void)hcb_updateIndicators;
- (void)hcb_unregisterFromNotifications;
- (void)hcb_registerForNotifications;
