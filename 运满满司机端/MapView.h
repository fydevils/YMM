...
- (_Bool)fitVisibleMapRect:(struct BMRect)arg1 width:(double)arg2 height:(double)arg3 centerXOffset:(double)arg4 centerYOffset:(double)arg5 withAnimation:(_Bool)arg6;
