...
@class AVCaptureConnection, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureSession, AVCaptureVideoPreviewLayer, MGMovieRecorder, NSDictionary, NSObject<OS_dispatch_queue>, NSString;
