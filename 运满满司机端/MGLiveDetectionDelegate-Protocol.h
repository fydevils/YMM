...
- (void)detectionManagerSucessLiveDetection:(MGLiveDetectionManager *)arg1 liveDetectionType:(unsigned long long)arg2;
- (void)detectionManager:(MGLiveDetectionManager *)arg1 finishWithStep:(unsigned long long)arg2;
@end
