...
@interface EGNetworkInfoModel : NSObject <NSCoding>
{
    NSString *_networkChangeTime;
...
@property(copy, nonatomic) NSString *networkChangeTime; // @synthesize networkChangeTime=_networkChangeTime;
- (void).cxx_destruct;
